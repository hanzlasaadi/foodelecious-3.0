                                                ...
                                                <div class="card h-100">
                                                    <div class="card-body h-100 p-1">
                                                        <div class="pos-product">
                                                            ...
                                                            <div class="info">
                                                                <div class="title text-truncate">Grill Chicken Chop®</div>
                                                                <div class="desc text-truncate">chicken, egg, mushroom, salad</div>
                                                                <div class="d-flex align-items-center mb-3">
                                                                    <div class="w-100px">Stock:</div><div class="flex-1">
                                                                ...
                                                                <div class="d-flex align-items-center mb-3">
                                                                    ...
                                                                    <div class="flex-1">
                                                                        <div class="form-check form-switch">
                                                                            <input class="form-check-input" type="checkbox" name="qty" id="product1" value="1" checked="" />
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <a href="#/" class="btn btn-success d-block mb-2"><i class="fa fa-check fa-fw"></i> Update</a>
